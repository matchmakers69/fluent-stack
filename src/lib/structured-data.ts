  ...
  return {
    ...
    hasOfferCatalog: {
      ...
      itemListElement:
        locale === 'pl'
          ? [
              { '@type': 'Offer', itemOffered: { '@type': 'Course', name: 'Angielski dla programistów' } },
              { '@type': 'Offer', itemOffered: { '@type': 'Course', name: 'Business English' } },
              { '@type': 'Offer', itemOffered: { '@type': 'Course', name: 'Przygotowanie do matury z angielskiego' } },
              { '@type': 'Offer', itemOffered: { '@type': 'Course', name: 'Przygotowanie do CAE/FCE' } },
              { '@type': 'Offer', itemOffered: { '@type': 'Course', name: 'Konwersacje po angielsku' } },
            ]
          : [
              { '@type': 'Offer', itemOffered: { '@type': 'Course', name: 'English for Developers' } },
              { '@type': 'Offer', itemOffered: { '@type': 'Course', name: 'Business English' } },
              { '@type': 'Offer', itemOffered: { '@type': 'Course', name: 'Matura Preparation' } },
              { '@type': 'Offer', itemOffered: { '@type': 'Course', name: 'Cambridge CAE/FCE Preparation' } },
...
export function localBusinessSchema(locale: Locale) {
  return {
    ...
    name: SITE_NAME,
    description:
      locale === 'pl' ? 'Korepetycje z angielskiego online' : 'Online English tutoring',
    url: SITE_URL,
    priceRange: '$$',
